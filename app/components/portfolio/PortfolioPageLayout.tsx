...
import { PORTFOLIO_CATEGORIES, MAILTO_CTA } from "@/app/lib/constants";
...
export function PortfolioPageLayout({
  ...
  const otherCategories = PORTFOLIO_CATEGORIES.filter((c) => c.id !== categoryId);
